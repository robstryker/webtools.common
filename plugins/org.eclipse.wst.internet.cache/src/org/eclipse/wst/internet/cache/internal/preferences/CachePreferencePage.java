    ...
    IWorkbenchPreferencePage
{
  ...
  protected Control createContents(Composite parent)
  {
    ...
    try
    {
      ...
      cacheDuration.setText(Long.toString(CachePlugin.getDefault().getCacheTimeout() / 1000));
      cacheDuration.addModifyListener(new ModifyListener() {
			public void modifyText(ModifyEvent e) {
	            CachePlugin.getDefault().setCacheTimeout(1000 * Long.parseLong(cacheDuration.getText()));
			}
      });
